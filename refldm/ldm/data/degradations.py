"""This file contains the copied BasicSR degradation utilities used by the vendored Ref-LDM dataset."""
import cv2
import math
import numpy as np
import random
...
try:
    ...
    # Newer torchvision releases moved the helper into functional.
